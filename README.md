...
This project combines and analyzes traffic violation data, specifically red light violations and speeding violations, to provide a comprehensive view of traffic law compliance. By merging these datasets, the project allows for deeper insights into patterns of unsafe driving behavior and helps identify areas for potential policy intervention or public safety initiatives.
...
Output results in a readable format (console, CSV, or visualization).
